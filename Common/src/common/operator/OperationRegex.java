...
/**
 * <p>
 * A strategy class used as an input instance in the operator context to check for a positive
 * Regular Expression evaluation result.
 * </p>
 * 
 * <ul>
 ...
 */
public class OperationRegex implements OperationStrategy
{
    /**
     * Evaluates the Regular Expression to determine whether the result is successful.
     * 
     * @param regex
