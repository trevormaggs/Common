 ...
 */
public final class RelationalOperator2
{
     ...
     */
    private RelationalOperator2(OperationStrategy strategy)
    {
    ...
    public static <T extends Comparable<T>> boolean execute(T operand1, String operator, T operand2)
    {
        ...
        return new RelationalOperator2(strategy).executeStrategy(operand1, operand2);
    }
}